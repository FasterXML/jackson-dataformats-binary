...
//        _tokenInputTotal = _currInputProcessed + _inputPtr;
        ...
        switch (ch) {
        // MAJOR 0: short shared string value reference

        case 0x0: // except for this value
            return _reportUnknownTypeToken(ch);
        ...
        // MAJOR 1: simple literals, numbers
        ...
        case 0x25: case 0x26: // VInt (zigzag), BigInteger
            _tokenIncomplete = true;
            return (_currToken = JsonToken.VALUE_NUMBER_INT);
        case 0x27: // reserved for future use
            return _reportUnknownTypeToken(ch);
        case 0x28: case 0x29: case 0x2A: // floating-point
            _tokenIncomplete = true;
            return (_currToken = JsonToken.VALUE_NUMBER_FLOAT);
        case 0x2B: case 0x2C: case 0x2D: case 0x2E: case 0x2F:
        case 0x30: case 0x31: case 0x32: case 0x33: case 0x34: case 0x35: case 0x36: case 0x37:
        case 0x38: case 0x39: // reserved for future use
            return _reportUnknownTypeToken(ch);
        case 0x3A:
        {
            // == 0x3A == ':' -> possibly header signature for next chunk?
        ...
        // MAJOR 5 short Unicode

        // not included here, outside switch
        ...
        */
        ...
        // MAJOR 6: small integers; zigzag encoded
        ...
        // MAJOR 7: binary/long-text/long-shared/start-end-markers
        case 0xE0: // long variable length ASCII
            _tokenIncomplete = true;
            return (_currToken = JsonToken.VALUE_STRING);
        case 0xE1: case 0xE2: case 0xE3: // reserved for future use
            return _reportUnknownTypeToken(ch);
        case 0xE4: // long variable length unicode
            _tokenIncomplete = true;
            return (_currToken = JsonToken.VALUE_STRING);
        case 0xE5: case 0xE6: case 0xE7: // reserved for future use
            return _reportUnknownTypeToken(ch);
        case 0xE8: // binary, 7-bit (0xE8)
            _tokenIncomplete = true;
            return (_currToken = JsonToken.VALUE_EMBEDDED_OBJECT);
        case 0xE9: case 0xEA: case 0xEB: // reserved for future use
            return _reportUnknownTypeToken(ch);
        case 0xEC: // long shared string (0xEC)
        case 0xED:
        case 0xEE:
        case 0xEF:
            if (_inputPtr >= _inputEnd) {
        ...
        case 0xF0: case 0xF1: case 0xF2: case 0xF3: // Reserved for future use
        case 0xF4: case 0xF5: case 0xF6: case 0xF7: // Reserved for future use
            return _reportUnknownTypeToken(ch);
        ...
        case 0xFB: // not used in this mode; would be END_OBJECT
            _reportError("Invalid type marker byte 0xFB in value mode (would be END_OBJECT in key mode)");
        case 0xFC: // end-of-String marker -- not used here
            return _reportUnknownTypeToken(ch);
        case 0xFD: // binary, raw
            _tokenIncomplete = true;
            return (_currToken = JsonToken.VALUE_EMBEDDED_OBJECT);
        case 0xFE: // reserved for future use
            return _reportUnknownTypeToken(ch);
        case 0xFF: // 0xFF, end of content
            return (_currToken = null);
        }
        
        // And now short text values:
    ...
    // should we change description based on reserved vs illegal?
    private JsonToken _reportUnknownTypeToken(int ch) throws IOException {

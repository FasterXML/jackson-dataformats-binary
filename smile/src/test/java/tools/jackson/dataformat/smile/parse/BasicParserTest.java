...
public class BasicParserTest extends BaseTestForSmile
{
    ...
    public void testLongUnicodeString() throws IOException
    {
        ...
        StringWriter w = new StringWriter();
        assertEquals(LONG.length(), p.getString(w));
    ...
    public void testUnicodeStringValues() throws IOException
    {
        ...
        assertToken(JsonToken.START_ARRAY, p.nextToken());
        assertToken(JsonToken.VALUE_STRING, p.nextToken());
        assertEquals(longer, p.getString());
        assertToken(JsonToken.END_ARRAY, p.nextToken());
        assertNull(p.nextToken());
        p.close();
    }
    ...
    public void testNameBoundary() throws IOException
    {
        ...
        for (int offset = 0; offset < 12; ++offset) {
            ...
            do {
                ...
                // importa
                gen.writeNumberProperty(FIELD, count % 17);
                gen.writeEndObject();
                ++count;
    ...
    public void testCharacters() throws IOException
    {
        ...
        jgen.writeStringProperty("key", "value");
        jgen.writeEndObject();
        jgen.writeStartObject();
        jgen.writeStringProperty("key", "value");
        jgen.writeEndObject();
        ...
        assertToken(JsonToken.START_OBJECT, p.nextToken());
        assertToken(JsonToken.PROPERTY_NAME, p.nextToken());
        str = new String(p.getStringCharacters(), p.getStringOffset(), p.getStringLength());
